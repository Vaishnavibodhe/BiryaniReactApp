        ...
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              <p className="text-sm ">
              Our Biryani is a testament to the culinary heritage that has
               been passed down through generations. We take pride in preserving
                the authenticity of each recipe while adding our own touch of innovation,
                 ensuring that you get a taste of tradition with every order
              </p>
              <div>
